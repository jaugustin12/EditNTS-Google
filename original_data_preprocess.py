...
with open('data/raw/sentence-aligned.v2/normal-processed.txt') as f:
    lines = f.readlines()

with open('data/raw/sentence-aligned.v2/simple-processed.txt') as g:
    lines2 = g.readlines()

editnet_data_to_editnetID(process_raw_data(lines, lines2),'data/interim/document-alignedv2.pkl')
